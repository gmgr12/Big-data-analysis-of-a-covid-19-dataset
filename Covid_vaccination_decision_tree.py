...
dtr = DecisionTreeRegressor(featuresCol='features', labelCol='total_vaccinations')

# Fit the model on the training data
dtr_model = dtr.fit(train_data)

pred_result = dtr_model.transform(test_data)
...
print("R2 on test data decision tree = ", pred_evaluator.evaluate(pred_result))
